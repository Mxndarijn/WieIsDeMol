...
LanguageText {
    ...
    CHEST_CONFIGURE_TOOL_CHEST_ADDED("container-configure-tool-container-added"),
    CHEST_CONFIGURE_TOOL_INFO("container-configure-tool-info"),
    CHEST_CONFIGURE_TOOL_ENTER_NAME("container-configure-tool-enter-name"),
    CHEST_CONFIGURE_TOOL_CHEST_REMOVED("container-configure-tool-container-removed"),
    ...
    MAP_AUTOMATED_CHEST_ADDED("map-automated-container-added"),
    MAP_AUTOMATED_CHEST_REMOVED("map-automated-container-removed"),
    MAP_CHEST_IS_NOT_A_CHEST("map-container-is-not-a-container"),
    MAP_SHULKER_IS_NOT_A_SHULKER("map-shulker-is-not-a-shulker"),
    CHEST_TOOL_INFO("container-tool-info"),
    ...
    MAP_CHEST_ATTACHMENT_ADDED("map-container-attachment-added"),
    MAP_CHEST_ATTACHMENT_COULD_NOT_ADD("map-container-attachment-could-not-add"),
    MAP_CHEST_ATTACHMENT_COULD_NOT_REMOVE("map-container-attachment-could-not-remove"),
    MAP_CHEST_ATTACHMENT_REMOVED("map-container-attachment-removed"),
    MAP_CHEST_COULD_NOT_BE_FOUND("map-container-could-not-be-found"),
    MAP_CHEST_ATTACHMENT_LIMITED_ENTER_NEW_AMOUNT("map-container-attachment-limited-enter-new-amount"),
    MAP_CHEST_ATTACHMENT_LIMITED_NOT_A_NUMBER("map-container-attachment-limited-not-a-number"),
    MAP_CHEST_ATTACHMENT_LIMITED_CHANGED_TO("map-container-attachment-limited-changed-to"),
    MAP_CHEST_ATTACHMENT_APPEARANCE_CHANGED_TO("map-container-attachment-appearance-changed-to"),
    MAP_CHEST_ATTACHMENT_LOCK_NO_ITEM_IN_HAND("map-container-attachment-lock-no-item-in-hand"),
    MAP_CHEST_ATTACHMENT_LOCK_ITEM_SET("map-container-attachment-lock-item-set"),
